...
def main():
    ...
    prompt="""Create a company logo where name of the company is Oxycaf which derived from element name like Oxygen , Calcium and flourine, This company provides Hospital management web solutions."""
