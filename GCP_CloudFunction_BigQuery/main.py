...
with open("D:/VSCode/GitRepos/PythonHacks/GCP_CloudFunction_BigQuery/schemas.yaml") as schema_file:
     config = yaml.load(schema_file, Loader=yaml.Loader)

# set key credentials file path
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = 'D:/VSCode/GitRepos/PythonHacks/GCP_CloudFunction_BigQuery/cloudquicklabs-4c5d874844c0.json'

PROJECT_ID = os.getenv('cloudquicklabs')
BQ_DATASET = 'staging'
CS = storage.Client()
BQ = bigquery.Client()
